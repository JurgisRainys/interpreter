...
let prodIdxToNonTerminal (prodIdx:int) = 
  match prodIdx with
    ...
    | 61 -> NONTERM_functionArguments 
    | 62 -> NONTERM_functionArguments 
    | 63 -> NONTERM_functionCall 
